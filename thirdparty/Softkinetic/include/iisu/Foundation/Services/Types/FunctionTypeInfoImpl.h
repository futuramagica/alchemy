...
namespace SK
{
  ...
  #define SK_FUNC_TYPE_DEFINITION \
	...
	private:
			...
			SK_FUNC_TYPE_DEF(FUNCTION_RETURNVOID_INT32T_VECTOR3);
			SK_FUNC_TYPE_DEF(FUNCTION_RETURNVOID_INT16T);
	...
	{	
		...
		template<typename T> struct FunctionType
		{
			...
			SK_FUNC_TYPE_ID(SK::Return<void>(int32_t, const SK::Vector3&)                                                           , FUNCTION_RETURNVOID_INT32T_VECTOR3                                                                                     , "FUNCTION : Return<void>(int32_t, const Vector3&)");                                                                   
			SK_FUNC_TYPE_ID(SK::Return<void>(int16_t)                                                                               , FUNCTION_RETURNVOID_INT16T                                                                                             , "FUNCTION : Return<void>(int16_t)");                                                                                   
